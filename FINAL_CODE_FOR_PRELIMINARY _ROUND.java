...
////        for pattern 2
      else if (patt.equals("2")) {
           moveToWrapper(10.547, -9.90, 5.453, 0, 0, -0.43, 0.90);
          api.laserControl(true);
...
////     for pattern 8
        ...
        //     for pattern 1
        else if (patt.equals("1")) {
            moveToWrapper(11.5, -9.8, 5, 0, 0, -0.707, 0.707);
            moveToWrapper(11.448, -9.8, 5.00, -0.35, 0, -0.79, 0.51);
            api.laserControl(true);
